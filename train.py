...
def load_primary_models(pretrained_model_path):
    ...
    unet = UNet3DConditionModel.from_pretrained(pretrained_model_path, subfolder="unet", class_embed_type="projection",
                                                projection_class_embeddings_input_dim=16, revision=None,
...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    text_encoder_lora_params, text_encoder_negation = lora_manager.add_lora_to_model(
        use_text_lora, text_encoder, lora_manager.text_encoder_replace_modules, lora_text_dropout, lora_path,
        r=lora_rank)
                ...
                if should_sample(global_step, validation_steps, validation_data):
                    ...
                    if accelerator.is_main_process:
                        with accelerator.autocast():
                            ...
                            export_to_video(video_frames, out_file, train_data.get('fps', 1))
